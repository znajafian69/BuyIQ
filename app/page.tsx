              ...
              <div style={{
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontFamily: 'Rajdhani, sans-serif', fontSize: 20, fontWeight: 700, color: '#fff', marginBottom: 4 }}>
                    Apple AirPods Pro 3 — Full Review
                  </div>
                  <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.5)', marginBottom: 10 }}>
                    Live Translation, Heart Rate Sensor, FDA Hearing Aid. Is it worth $199?
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    <span style={{ color: '#f5a623', fontSize: 13 }}>★★★★½</span>
                    <span style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>8,004 reviews</span>
                    <span style={{
